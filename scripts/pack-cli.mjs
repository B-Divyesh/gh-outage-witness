...
const stage = resolve(root, 'dist/package/ci-outage-witness_0.1.1_linux_x86_64');
...
result = spawnSync('tar', ['-czf', '../ci-outage-witness_0.1.1_linux_x86_64.tar.gz', '.'], { cwd: stage, stdio: 'inherit' });
if (result.status !== 0) process.exit(result.status ?? 1);
